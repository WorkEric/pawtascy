...
module.exports = (sequelize, DataTypes) => {
  ...
  event_pet_category.associate = function(models) {
    models.event_pet_category.belongsTo(models.event, {foreignKey: 'event_id', targetKey: 'id'})
    models.event_pet_category.belongsTo(models.pet_category, {foreignKey: 'pet_category_id', targetKey: 'id'})
  };
