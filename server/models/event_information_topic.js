...
module.exports = (sequelize, DataTypes) => {
  ...
  event_information_topic.associate = function(models) {
    models.event_information_topic.belongsTo(models.event, {foreignKey: 'event_id', targetKey: 'id'})
    models.event_information_topic.belongsTo(models.event_topic, {foreignKey: 'event_topic_id', targetKey: 'id'})
  };
